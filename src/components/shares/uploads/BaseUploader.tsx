  ...
  return (
    <div className="relative px-0 flex flex-col">
      ...
      <div className="flex flex-row gap-3 items-center">
        <label
          htmlFor={id}
          className=" inline-block py-2 px-3 bg-clr-text-primary rounded-3xl border-1 border-solid border-clr-text-secondary-darken cursor-pointer text-clr-text-black w-1/6 hover:bg-clr-background-highlight-three"
        >
          Choose File
        </label>
